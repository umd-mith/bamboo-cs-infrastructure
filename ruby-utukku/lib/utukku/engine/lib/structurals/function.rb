module Utukku::Engine::Lib::Structurals
  class Function < Utukku::Engine::Structural
  ...
  class Mapping < Utukku::Engine::Structural
    namespace Utukku::Engine::NS::LIB
  ...
  class Reduction < Utukku::Engine::Structural
    namespace Utukku::Engine::NS::LIB
  ...
  class Consolidation < Utukku::Engine::Structural
    namespace Utukku::Engine::NS::LIB
  ...
  class Template < Utukku::Engine::Structural
    namespace Utukku::Engine::NS::LIB
    ...
    def compile_xml(xml, context)
      ...
      if !xml.nil?
        ctx = nil
        if xml.name == 'template' && xml.namespace.href == Utukku::Engine::NS::LIB
    ...
    def run(context, autovivify = false)
      ...
      @context.with(context) do |ctx|
        @actions.each do |action|
          if action.is_a?(String)
            ...
            s += r.collect { |v| v.to([Utukku::Engine::NS::FAB, 'string'], ctx).value }.join('')
          end
        end
      end
      s.gsub!(/^\s+/, '')
      ...
      return [ context.root.anon_node(s, [ Utukku::Engine::NS::FAB, 'string' ]) ]
    end
  end
end
