...
require 'utukku/engine/context_iterator'

class Utukku::Engine::Parser::Axis < Utukku::Engine::Expression
  ...
  def run(context, autovivify = false)
    if @root.nil? || @root == ''
      ...
      context.transform do |ctx|
        if context.root.roots[@root].nil? && !Utukku::Engine::TagLib.axes[@root].nil?
          context.root.roots[@root] = Utukku::Engine::TagLib.axes[@root].call(context)
        end
        context.root.roots[@root].nil? ? Utukku::Engine::NullIterator.new : 
          @axis.nil? ? Utukku::Engine::ConstantIterator.new([context.root.roots[@root]]) : 
...
class Utukku::Engine::Parser::AxisChild < Utukku::Engine::Expression
  def initialize(n)
    @node_test = n
  end
...
class Utukku::Engine::Parser::AxisDescendentOrSelf < Utukku::Engine::Expression
...
class Utukku::Engine::Parser::AxisParent < Utukku::Engine::Expression
  def run(context, autovivify = false)
    if context.is_a?(Array)
...
class Utukku::Engine::Parser::AxisAttribute < Utukku::Engine::Expression
  def initialize(n)
    @name = n
  end
    ...
    res = context.collect { |c|
      ...
      if nom == 'type'
        if c.root.vtype.nil?
          ...
          n.name = 'type'
          n.vtype = [ Utukku::Engine::NS::FAB, 'uri' ]
          n
        end
      else
