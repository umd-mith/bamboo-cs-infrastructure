...
module Utukku::Template::Taggable
  ...
  module ClassMethods
    ...
    def tag_descriptions(hash = nil)
      Utukku::Template::Taggable.tag_descriptions[self.name] ||= (hash ||{})
    end
  
    def desc(text)
      Utukku::Template::Taggable.last_description = RedCloth.new(Util.strip_leading_whitespace(text)).to_html
    end
    
    def tag(name, &block)
      self.tag_descriptions[name] = Utukku::Template::Taggable.last_description if Utukku::Template::Taggable.last_description
      Utukku::Template::Taggable.last_description = nil
