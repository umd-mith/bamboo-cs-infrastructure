...
module Bamboo::Template::Taggable
  ...
  module ClassMethods
    ...
    def tag_descriptions(hash = nil)
      Bamboo::Template::Taggable.tag_descriptions[self.name] ||= (hash ||{})
    end
  
    def desc(text)
      Bamboo::Template::Taggable.last_description = RedCloth.new(Util.strip_leading_whitespace(text)).to_html
    end
    
    def tag(name, &block)
      self.tag_descriptions[name] = Bamboo::Template::Taggable.last_description if Bamboo::Template::Taggable.last_description
      Bamboo::Template::Taggable.last_description = nil
