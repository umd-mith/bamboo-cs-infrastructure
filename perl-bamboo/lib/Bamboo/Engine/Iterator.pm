package Bamboo::Engine::Iterator;
  use Moose;
...
=head1 SYNOPSIS
 ...
 my $it = Bamboo::Engine::Iterator -> new(
...
=cut
  ...
  sub start {
    my($self) = @_;
    my $visitor = Bamboo::Engine::Iterator::Visitor -> new( iterator => $self );
    $visitor -> start;

    return $visitor;
  }

package Bamboo::Engine::Iterator::Visitor;
  use Moose;
